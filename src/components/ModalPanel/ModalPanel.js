...
class ModalPanel extends Component {
    render() {
        ...
        console.log(isOpen);
        return (
            <Modal className="s-slider" isOpen={isOpen} id="exampleModal" fade>
                <div className="about-wrapper container">
                    <div className="header-row row">
                        <div className="flexed-row">
                            <div className="col-auto col-sm-3 col-md-10 h2 info ">
                                <svg className="i_icon" width="20" height="20" viewBox="0 0 20 20" fill="none"
                            ...
                            <div className="col-2 close_wrapper">
                                <button onClick={() => toggleModal()} data-dismiss="modal" data-target="#exampleModal"
                                        className="btn ico-slider-close"
                                >
                                    <svg className="ico-slider-close-svg" width="14" height="14" viewBox="0 0 14 14"
                                         fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path className="ico-slider-close-path"
                    ...
                    <div className="contact-info-row">
                        <div className="contact-info-row-wrapper">
                            <div className="col-12 col-sm-6 md-6 d-flex">
                                <div className=" col-12 col-sm-12 col-md-12 col-lg-6">
                                    <ul className="s-about-list">
                                        <li className="s-about-list-element h1">Contact info</li>
                                        <li className="s-about-list-element panel-mail">
                                            <svg className="s-about-list-element__img" width="20" height="16"
                                            ...
                                            <a className="s-about-list-element__link" href="mailto:DIGITDD@GMAIL.COM">digitdd@gmail.com</a>
                                        </li>
                                        <li className="s-about-list-element panel-skype">
                                            <svg className="s-about-list-element__img" width="22" height="22"
                                            ...
                                            <a className="s-about-list-element__link"
                                               href="http://DIGITDESIGN.ORG/">digitdesign.org</a>
                                        </li>
                                        <li className="s-about-list-element panel-slack">
                                            <svg className="s-about-list-element__img" width="22" height="22"
                                                 viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                <div className=" col-12 col-sm-12 col-md-12 col-lg-6">
                                    <ul className="s-about-list">
                                        <li className="s-about-list-element h1">Career</li>
                                        <li className="s-about-list-element years ">
                                            <span className="s-about-list-element__year">2018 — </span>OMEGA-R
                                        </li>
                                        <li className="s-about-list-element years ">
                                            <span className="s-about-list-element__year">2017 — </span>WEBSOLUTIONS.by
                                        </li>
                                        <li className="s-about-list-element years"><span
                                            className="s-about-list-element__year">2015 — </span>ARTEZIO.COM
                                        </li>
                                        <li className="s-about-list-element years"><span
                                            className="s-about-list-element__year">2013 — </span>FREELANCE
                                        </li>
                                        <li className="s-about-list-element years"><span
                                            className="s-about-list-element__year">2011 — </span>ATMATIC.COM
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-12 col-sm-6 col-md-6 d-flex">
                                <div className="col-12  col-sm-12 col-md-12 col-lg-6">
                                    <ul className="s-about-list">
                                        <li className="s-about-list-element h1">Skills</li>
                                        <li className="s-about-list-element text">
                                            <p className="element-about-paragraph"> UI, UX, Web design, Graphic design,
                                                Illustrations, Banners, Prints, Animation, Presentations, Interfaces,
                                                Flash,
                                                Corporate Identity, Logo, UI design, Game design, Mobile design.
                                            </p>
                                            <p className="element-about-paragraph">Adobe Photoshop, Adobe illustrator,
                                                Corel
                                                Draw,
                                                Adobe Animate, Word, Power Point, Zeplin, Figma</p>
                                ...
                                <div className="col-12 col-sm-12 col-md-12 col-lg-6">
                                    <ul className="s-about-list">
                                        <li className="s-about-list-element h1">About me</li>
                                        <li className="s-about-list-element element-about">
                                            <p className="element-about-paragraph with-photo"><img
                                                className="element-about-paragraph-image"
                                                src="/image/ava_me_for_site02.png" alt="ava_me"/></p>
                                            <p className="element-about-paragraph">Hello! My name is
                                                Alexander. I was born in 1987. I
                                                have
                                                higher education in informatics university of the country. There is
                                                taste in
                                                art, communication, responsibility, accuracy.</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
