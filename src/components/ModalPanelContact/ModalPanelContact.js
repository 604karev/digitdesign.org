...
import './ModalPanelContact.sass'

const modalPanelContact = ({contactIsOpen, toggleModalContact}) => {
    return (
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-6">
                                <textarea className="contact-us__area w-100" name="contact-us__area" id="" cols="30" rows="10" >
                                    What would you like to ask us? Maybe you have specific suggestions?
                                </textarea>
                            </div>
                        </div>
                    </div>
