...
const ModalPanelInfo = ({infoIsOpen, toggleModal, reviews}) => {

    const renderReviews = (review) => {

        const renderSocial = ({link, img}, index) => {
            return (
                <a key={index} className="reviews-messengers__link" href={link}>
                        ...
                        <div className="row">
                                    ...
                                    <ul className="social-list">
                                        <li className="social-list__item">
                                            <a className="social-list__link"
                                               href='https://www.facebook.com/digitdesign.org'>
                                        ...
                                        <li className="social-list__item">
                                            <a className="social-list__link"
                                               href='https://www.linkedin.com/in/alexanderhreben/'>
                                        ...
                                        <li className="social-list__item">
                                            <a className="social-list__link" href='https://www.behance.net/digitdesign'>
                                        ...
                                        <li className="social-list__item">
                                            <a className="social-list__link" href='https://dribbble.com/DigitDesign'>
                                                <svg className="social-list__image" width="30" height="30"
                                                     viewBox="0 0 30 30" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path fillRule="evenodd" clipRule="evenodd"
                                        ...
                                        <li className="social-list__item">
                                            <a className="social-list__link"
                                               href='https://www.instagram.com/digitdesign/'>
                                                <svg className="social-list__image" width="30" height="30"
                                                     viewBox="0 0 30 30" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="col-sm-6 col-lg-3 px-xl-2">
                                <div className="contact-block">
                                    ...
                                    <p className="contact-block__paragraph">Hello! My name is Alex. I'm a skilled Ui/Ux
                                        designer with over then 10 years of experience. I have higher education in
                                        informatics. I'm easy-going, responsible and love what i'm doing! Looking
                                        forward to work on your projects!</p>
                                </div>
                            </div>
                        </div>
                    </div>
