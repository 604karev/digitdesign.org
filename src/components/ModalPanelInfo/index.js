                                    ...
                                    <ul className="social-list">
                                        <li className="social-list__item">
                                            <Link className="social-list__link" to='#'>
                                                <svg className="social-list__image social-list__image_facebook" width="8" height="17" viewBox="0 0 8 17" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                        ...
                                        <li className="social-list__item">
                                            <Link className="social-list__link" to='#'>
                                                <svg className="social-list__image" width="31" height="30" viewBox="0 0 31 30" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <li className="social-list__item">
                                            <Link className="social-list__link" to='#'>
                                                <svg className="social-list__image" width="30" height="30" viewBox="0 0 30 30" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path fillRule="evenodd" clipRule="evenodd"
